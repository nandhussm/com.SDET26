...
public class ConvertLeadToOpertunitiesBySelectingAllTheChekboxsAndChangeTheOpertunityName {
	public static void main(String[] args) throws IOException {
	    ...
	    wdu.mouseOverElement(driver,   driver.findElement(By.name("entities[]")));
	    driver.findElement(By.name("entities[]")).click();
	    driver.findElement(By.id("jscal_trigger_closedate")).click();
	       wdu.mouseOverElement(driver, driver.findElement(By.xpath("//td[@class='day selected today']/../..")));
